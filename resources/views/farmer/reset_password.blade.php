            ...
            <div class="collapse- navbar-collapse" id="navbarNav-">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item" style="margin: 2em;">
                        <a class="nav-link" href="{{ route('farmer') }}" >Register</a>
                    </li>

                    <li class="nav-item" style="margin: 2em;">
                        <a class="nav-link" href="{{ route('farmer.login') }}" >Login</a>
                    </li>
                    @else
                    <li class="nav-item">
            ...
            <div class="col-md-4 col-xs-12">
                <div class="card" style="border: 2px solid #eee; background: #ccc;">
                    ...
                    <span class="gen- btn btn-xlg btn-info">Generate password (recomended)</span>
                        ...
                        <form method="POST" action="{{route('farmer.reset.password',['email'=>$data[0], 'token'=>$data[1] ])}}">
                            @csrf
