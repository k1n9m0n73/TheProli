...
<div class="data-table-area mg-b-15">
            <div class="container-fluid">
                       ...
                       <a href="#4" style="text-decoration: none;">
                        ...
                        <a href="/farmer/product/edit" style="text-decoration: none;" link-id>
                            <li class="li_">
                    ...
                    // });
                     ...
                     //})
                         ...
                         <div class="col-md-10 col-lg-10 col-sm-10 -col-xs-12 pane1">
                             @include('farmer.component.product.details.pane0')
                             @include('farmer.component.product.details.pane1')
                             @include('farmer.component.product.details.pane2')
                             @include('farmer.component.product.details.pane3')
                             @include('farmer.component.product.details.pane4')
