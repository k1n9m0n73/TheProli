        ...
        <div class="container">
            ...
            <div class="collapse- navbar-collapse" id="navbarNav-">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/warehouse/register">Register</a>
                    </li>
                    @else
                    <li class="nav-item">
                    <a class="nav-link" href="/warehouse/logout">Logout {{$user['fn']}}</a>
                    </li>
                    @endguest
                </ul>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 col-xs-12">
                <div class="card" style="border: 2px solid #eee; background: #ccc;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('warehouse.request.password') }}">
                            @csrf
