            ...
            <div class="collapse- navbar-collapse" id="navbarNav-">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item" style="margin: 2em;">
                        <a class="nav-link" href="/warehous" >Register</a>
                    </li>

                    <li class="nav-item" style="margin: 2em;">
                        <a class="nav-link" href="/warehouser/login" >Login</a>
                    </li>
                    @else
                    <li class="nav-item">
                        <a class="nav-link" href="/waerehouse/logout">Logout</a>
                    </li>
                    @endguest
                </ul>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 col-xs-12">
                <div class="card" style="border: 2px solid #eee; background: #ccc;">
                    <h3 class="card-header text-center bkg ht" style="color:#fff;padding:20px">aggregator Login</h3>
                    <div class="card-body">
                    <span class="gen- btn btn-xlg btn-info">Generate password (recomended)</span>
                 
                        <form method="POST" action="{{route('warehouse.reset.password',['email'=>$data[0], 'token'=>$data[1] ])}}">
                            @csrf
