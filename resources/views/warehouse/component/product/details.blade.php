...
<div class="data-table-area mg-b-15">
            <div class="container-fluid">
                       ...
                       <a href="#4" style="text-decoration: none;">
                        ...
                        <a href="/warehouse/product/edit" style="text-decoration: none;" link-id>
                            <li class="li_">
                   ...
                   //  allbtn.forEach(el=>{
                    ...
                    //  if (e.target.hasAttribute("edit-sch-btn")) {
                        ...
                        let userData = user().getData({
                            appends:['single',0,"{{$id}}"],
                            url:"/warehouse/product/process/detail_props",
                    ...
                    // });
                     ...
                     //})
                         ...
                         <div class="col-md-10 col-lg-10 col-sm-10 -col-xs-12 pane1">
                             @include('warehouse.component.product.details.pane0')
                             @include('warehouse.component.product.details.pane1')
                             @include('warehouse.component.product.details.pane2')
                             @include('warehouse.component.product.details.pane3')
                             @include('warehouse.component.product.details.pane4')
