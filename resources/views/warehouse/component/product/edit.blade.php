...
<div class="col-sm-12 col-md-12"    id="AnnTable" >
  ...
  <div class="card-header"   style="background-color:#89dd52;color:#fff;padding:6px">
    ...
    <div class=" wr-" >  
         ...
         window.addEventListener('load',function(){           
                ...
                let s =  pr.getData({
                    ...
                    url:"/aggregator/product/set_deal",
    ...
    <!-- ================================================================================================= -->
     ...
     <form action="/aggregator/product/update"  department p__ method="post" mess__ class="item-contaner" >
      @csrf
                    <div class="wr" >  
                      ...
                      function handleDealCalculation(){
                           ...
                           ['change','keyup'].forEach(ev=>{
                                            ...
                                            document.querySelector("input[name='poff']").addEventListener(ev,function(){
                                                let price2 = $data.data.m==1?parseFloat( $data.data.k__ ): ($data.data.k__- parseFloat( $data.data.k__ )*parseFloat($data.data.m))
                                            console.log(this.value);
