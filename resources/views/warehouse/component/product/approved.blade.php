...
<div class="col-sm-12 col-md-12"    id="AnnTable" >
  <div class="panel panel-bd lobidrag">
     ...
     <form action="/warehouse/create-employment"  department p__ method="post" forms >
      @csrf
        <!-- ./Plugin content:powerpoint,txt,pdf,png,word,xl -->
...
<script type="text/javascript">
 ...
 /* **Filter selecter****/
  ...
  let new_data = user().getData({
      appends:toAppend,url:"/warehouse/product/process/approve-product?"+numCof2[1]+"",
 ...
 let  list  =``;
    dataList.forEach( ($o,$key)=>{
      ...
      list+=`<tr class="parent${$key}"  data-user="${$o.a}" row-index="${($key+1)}"> 
                                        ...
                                        <td > 
                                     <a   href="/warehouse/product/view_detail__${$o.a}"><button type="button" class=" btn btn-xs btn-success "><i class="zwicon-eye" ></i></button></a>
