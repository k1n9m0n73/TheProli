 ...
 <div class="container" style="margin-bottom: 13%;padding:12px">
       <div class="row" style="padding: 27px;margin-bottom: 38%">
         ...
         <div class="col-md-3 col-lg-3 col-sm-4 -col-xs-12">
                     ...
                     <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12  content-pane-0" >  
                        ...
                        <div class="profile__img">
                            <img src="/<?=$img?>" alt="" style="    width: 50%;height: 50%;">
                             <form action="/warehouse/uploadProfileImage" enctype="multipart/form-data" method="post" class="profile-image" >
                               @csrf
                   ...
                   <form enctype="multipart/form-data" action="/warehouse/addCategory" class="register" >
                     @csrf
                      ...
                      <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 box-white" >
                          ...
                          <div class="form-group mt-3">
                                      ...
                                      <select data-placeholder="Select types of storage"  is-req="" is-req-text="Storage type are required" multiple="" class="select2" tabindex="-1" name="so[]" style="min-height: 42px; display: none;">
                                                 @foreach($so as $opt => $vals):
                                                  <optgroup label="{{$opt}}">
                                                      @foreach($vals as $opt2 =>$val):
                                                        @if(in_array($val, $soa)):
                                        ...
                                        <select data-placeholder="Select package materials available..." multiple=""  is-req="" is-req-text="Packing materials are required" class="select2" name="po[]" >
                                          ...
                                          <div class="form-group mt-3">
                                            ...
                                            <input type="nummber" step="0.01" class="form-control" placeholder="Warehouse capacity" autocomplete="off" name="wc" is-req="" value="{{$user->cap}}" is-req-text="Warehouse capacity is required"  >
                                      </div>
...
document.querySelector("button[name='send_form']").addEventListener("click",function(){
   request.sendForm(this,document.querySelector("form.register"),"/warehouse/settings/profile/update") 
})
...
document.querySelector("button[name='uploadprofileimage']").addEventListener("click",function(){
   ...
   request.sendForm(this,document.querySelector("form.profile-image"),"/warehouse/settings/profile/update-profile-image", setImage) 
})
