...
resetPassword(document.querySelector("button.reset-password"),document.getElementById("reset-password"),'/warehouse/settings/security/resetPass2')
</script>