            ...
            <div class="collapse- navbar-collapse" id="navbarNav-">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item" style="margin: 2em;">
                        <a class="nav-link" href="/aggregator/login" >Login</a>
                    </li>
                    @else
                    <li class="nav-item">
  ...
  <div class="container" >
   <div class="row" style="margin-bottom: 38%">
                         ...
                         <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 col-lg-offset-2 col-md-offset-2" > 
                           ...
                           <span class="card-title " style="color: #fff;margin-bottom: -2px;;" >Aggregator registration</span>
                    ...
                    <div class="totalSubcategoryField"><input type="hidden" name="totalSubcategoryField" value="1"></div>
                      ...
                      <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 box-white" >
                       ...
                       <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 box-white subcategory-container" >
                         <h4 style="color: #000;margin: 0 29px">Personal information</h4>
                        ...
                        <div class="form-group mt-3">
                          ...
                          <div class="input-group form-group grouper" style="margin: 0px auto;margin-top: 12px;height:  37.9px;margin-bottom: 10px;width: 100%">
                           ...
                           <input type="text" class="form-control" placeholder="First name" autocomplete="off" name="fn" is-req="" is-req-text="First name is required"  >
                          </div>
                         </div> 
                          ...
                          <div class="input-group form-group grouper" style="margin: 0px auto;margin-top: 12px;height:  37.9px;margin-bottom: 10px;width: 100%">
                           ...
                           <input type="text" class="form-control" placeholder="Middle name" autocomplete="off" name="mn" is-req="" is-req-text="Middle name is required"  >
                          </div>
                         </div> 
                          ...
                          <div class="input-group form-group grouper" style="margin: 0px auto;margin-top: 12px;height:  37.9px;margin-bottom: 10px;width: 100%">
                           ...
                           <input type="text" class="form-control" placeholder="Last name" autocomplete="off" name="ln" is-req="" is-req-text="Last name is required"  >
                          </div>
                         </div> 
                          ...
                          <div class="input-group form-group grouper" style="margin: 0px auto;margin-top: 12px;height:  37.9px;margin-bottom: 10px;width: 100%">
                           ...
                           <input type="date"  class="form-control " autocomplete="off" placeholder="Pick a date"  name="ag" is-req="" is-req-text="Date of birth is required"  >
                          </div>
                         </div> 
                          ...
                          <div class="form-group mt-3">
                                <label>Gender </label>
                                   <select id="reg" type="text" class="form-control" is-req="" is-req-text="Gender is required"  name="ge"  >
                        ...
                        <div class="form-group mt-3">
                                <label>Highest level education</label>
                                   <select id="reg" type="text" class="form-control" is-req="" is-req-text="Highest level education required"  name="ed"  >
                                   <option value=" "> Select education level</option>
                                   <option>Professor</option>
                                   <option>Associate profesor</option>
                                  <option>Doctorate</option>
                                  <option>Master</option>
                                  <option>University gradute</option>
                                  <option>HND</option>
                                  <option>OND</option>
                                 <option>Grade II</option>
                                 <option>School cert</option>
                      ...
                      <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 box-white subcategory-container" >
                        ...
                        <div class="form-group mt-3">
                          ...
                          <div class="input-group form-group grouper" style="margin: 0px auto;margin-top: 12px;height:  37.9px;margin-bottom: 10px;width: 100%">
                           ...
                           <div class="form-group mt-3">
                            <label>Main contact number (can be use to login) e.g. +234-222-333-000</label>
                          <div class="input-group form-group grouper" style="margin: 0px auto;margin-top: 12px;height:  37.9px;margin-bottom: 10px;width: 100%">
                          ...
                          <div class="form-group mt-3">
                            <label>Other contact number e.g. +234-222-333-000</label>
                          <div class="input-group form-group grouper" style="margin: 0px auto;margin-top: 12px;height:  37.9px;margin-bottom: 10px;width: 100%">
                         <input type="text" name="pn2" class="form-control input-mask pn" data-mask="+000-000-000-0000" placeholder="eg: +234-700-000-0000 (optional)" autocomplete="off" maxlength="17" is-req-="" is-req-text="Other contact number is required" />
                          </div>
                       ...
                       <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 box-white subcategory-container" >
                        ...
                        <div class="form-group mt-3">
                          ...
                          <div class="form-group mt-3">
                            <label>Guarantor contact number e.g. +234-222-333-000</label>
                          <div class="input-group form-group grouper" style="margin: 0px auto;margin-top: 12px;height:  37.9px;margin-bottom: 10px;width: 100%">
                         <input type="text" name="gpn" class="form-control input-mask pn" data-mask="+000-000-000-0000" placeholder="eg: +234-700-000-0000 " autocomplete="off" maxlength="17" is-req-="" is-req-text="Guarantor contact number is required" />
                          </div>
                         </div> 
                     ...
                     <?php
                         ...
                         <div class="input-group">
                          ...
                          <span class="input-group-text" style="background-color: #ccc">
                            <i class="zwicon-calendar-never" style="color: #000"></i>
                           </span>
                           </div>
                             <input type="text" name="exp[]" class="form-control date-picker flatpickr-input" placeholder="Pick a date" readonly="readonly" is-req="" is-req-text="expiring date of <?=$value->doc?> is required">
                              </div>
                         </div>      
                       ...
                       <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 box-white subcategory-container" >
                        <div class="form-group" style="width: 78%;margin: 26px 60px;">
                                    <div class="custom-control custom-checkbox mb-2 mx-2">
                                        ...
                                        <label class="custom-control-label" for="customCheck1"><a href="/aggregator/information/terms-and-conditions">Accept terms and conditions</a></label>
                            ...
                            <button type="button" name="send_form"  is_category_request class="btn btn-theme" >Submit form <i class="fa fa-spinner anim" style="opacity: 0;"></i></button>
                </form>
                </div> 
   </div>
</div>
...
<div class="footer proli-page">
    ...
    <div class="footem bkg">
          <ul class="nav nav-bar nva-link">
              ...
              <ul class="nav nav-bar nva-link">
                <li><a href="/aggregator/informations/help-center">Help center</a></li>
                <li><a href="/aggregator/informations/terms-and-conditions">Terms &amp; Conditions</a></li>
     
                <li><a href="/aggregator/informations/privacy-policy">Privacy Policy</a></li> 
...
let chk  = request.validate(document.querySelectorAll("*[is-req]"),"is-req-text"); 
  ...
  if (chk) {
 // console.log(request);  
   request.sendForm(this,document.querySelector("form.register"),"/aggregator/post_register") 
