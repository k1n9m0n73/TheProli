      ...
      <div class="container">
            ...
            <!-- Login -->
              ...
              @csrf
                ...
                <a href="/aggregator/login?>"> <button style="margin:10px 0;border: none;" class="btn btn-danger exit-forget_" name="commit" tabindex="3" type="button" value="Log In">Exit</button>  </a> 
...
let btnPassReset = document.querySelector("button.request-password");
 ...
 promise =  user().getData({
     ...
     url:"/aggregator/regenerate-token",
     token: document.querySelector("input[name='_token']").value,
