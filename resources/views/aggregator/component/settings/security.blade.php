...
resetPassword(document.querySelector("button.reset-password"),document.getElementById("reset-password"),'/aggregator/settings/security/resetPass2')
</script>