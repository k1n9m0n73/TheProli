      ...
      <div class="container">
            ...
            <!-- Login -->
                       ...
                       <div class="input-group col-md-9 col-sm-9 col-xs-12" style="border: 1px solid #89DD52;margin: 0px auto;margin-top: 12px;">
                          ...
                          <input type="text"  name="fn" class="form-control" placeholder="First name " aria-describedby="basic-addon1" style="border: none;color: #000;  margin: 0 5px;"  value="<?=!empty($bank)? $bank[0]->fn:null ?>" >
                         ...
                         <div class="input-group col-md-9 col-sm-9 col-xs-12" style="border: 1px solid #89DD52;margin: 0px auto;margin-top: 12px;">
                          ...
                          <input type="text"  name="ln" class="form-control" placeholder="Last name " aria-describedby="basic-addon1" style="border: none;color: #000;  margin: 0 5px;" value="<?=!empty($bank)? $bank[0]->ln:null ?>">
                        
                        </div>

                          <div class="input-group col-md-9 col-sm-9 col-xs-12" style="border: 1px solid #89DD52;margin: 0px auto;margin-top: 12px;">
                     
                          <input type="text"  name="acc" class="form-control" placeholder="Account number " aria-describedby="basic-addon1" style="border: none;color: #000;  margin: 0 5px;"  value="<?=!empty($bank)? $bank[0]->accountnumber:null ?>">
                        ...
                        <div class="input-group col-md-9 col-sm-9 col-xs-12" style="border: 1px solid #89DD52;margin: 0px auto;margin-top: 12px;">
                         ...
                         <select type="text" class="form-control select2 " id="bank" name="bank">
                							...
                							<option selected><?=!empty($bank)? $bank[0]->bankname:null ?></option>
...
let btnPassReset = document.querySelector("button.bank_");
 ...
 promise =  user().getData({
   ...
   url:"/aggregator/settings/bank/account",
