...
<script type="text/javascript">
 ...
 /* **Filter selecter****/
  ...
  let new_data = user().getData({
      appends:toAppend,url:"/aggregator/product/process/expired-product?"+numCof2[1]+"",
 ...
 let  list  =``;
    dataList.forEach( ($o,$key)=>{
      ...
      list+=`<tr class="parent${$key}"  data-user="${$o.a}" row-index="${($key+1)}"> 
                                        ...
                                        <td > 
                                     <a   href="/aggregator/product/view_detail__${$o.a}"><button type="button" class=" btn btn-xs btn-success "><i class="zwicon-eye" ></i></button></a>
