                   ...
                   //  allbtn.forEach(el=>{
                    ...
                    //  if (e.target.hasAttribute("edit-sch-btn")) {
                        ...
                        let userData = user().getData({
                            appends:['single',0,"{{$id}}"],
                            url:"/aggregator/order/process/detail_props_",
                    ...
                    // });
                     ...
                     //})
                         ...
                         <div class="col-md-10 col-lg-10 col-sm-10 -col-xs-12 pane1">
                             @include('aggregator.component.order.details.pane0')
                             @include('aggregator.component.order.details.pane1')
                             @include('aggregator.component.order.details.pane2')
                             @include('aggregator.component.order.details.pane3')
                             @include('aggregator.component.order.details.pane4')
                             @include('aggregator.component.order.details.pane5')
