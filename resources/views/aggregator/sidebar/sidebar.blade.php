    ...
    height: 49px;"/></a></strong>
        ...
        <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                          ...
                          <li>
                          <a class="has-arrow-"  href="/aggregator/dashboard">
                      ...
                      <!-- =============================================== -->
                        ...
                        <li>
                            ...
                            <span class="mini-click-non">Product </span>
                                ...
                                <li>
                                    <a title="Proli product" href="/aggregator/product/product-sellable">Proli product list</a>
                                </li>
                                <li>
                                    <a title="upload code" href="/aggregator/product/upload-code">Upload code</a>
                                </li>
                                <li>
                                    <a href="/aggregator/product/add">Add product</a>
                                </li>
                                <li>
                                    <a title="Waiting product" href="/aggregator/product/waiting"> <span class="mini-sub-pro">Waiting products</span></a>
                                </li>
                                 <li>
                                    <a title="Approced product" href="/aggregator/product/approved"><span class="mini-sub-pro">Approved products</span></a>
                                </li>

                                <li>
                                    <a title="Expired product" href="/aggregator/product/expired-product"><span class="mini-sub-pro">Expired products</span></a>
                                </li>

                                <li>
                                    <a title="Deal product" href="/aggregator/product/deal"><span class="mini-sub-pro">Deal products</span></a>
                                </li>

                                <li>
                                    <a title="All product" href="/aggregator/product/all"><span class="mini-sub-pro">All products</span></a>
                                </li>
                           ...
                           <ul class="submenu-angle" aria-expanded="true">
                               ...
                               <li>
                                    <a href="/aggregator/order/today"> Today</a>
                                </li>
                             
                                <li>
                                    <a href="/aggregator/order/other_date_order"> Other date</a>
                                </li>

                                 <li>
                                    <a href="/aggregator/order/return_order"> Return order</a>
                                </li>
                        ...
                        <li>
                            ...
                            <span class="mini-click-non">Notification</span>
                             ...
                             <ul class="submenu-angle" aria-expanded="true">
                                 ...
                                 <li>
                                    <a href="/aggregator/notification/view">View</a>
                                  </li>
                        ...
                        <!-- =============================================== -->
                         ...
                         <a class="has-arrow" href="" >
                            ...
                            <ul>
                                <li>
                                    <a href="/aggregator/message/get#inbox"> Inbox</a>
                                </li>
                                <li>
                                    <a href="/aggregator/message/get#outbox"> Outbox</a>
                                </li>
                        ...
                        <a class="has-arrow" href="" >
                            ...
                            <ul>
                                <li>
                                    <a href="/aggregator/settings/document">Company document</a>
                                </li>
                                <li>
                                    <a href="/aggregator/settings/bank">Bank account</a>
                                </li>
                                <li>
                                    <a href="/aggregator/settings/security">Account security </a>
                                </li>
                               <li>
                                    <a href="/aggregator/settings/profile">Profile </a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <li>
                                    <a href="/aggregator/analytics/order">Order </a>
                                </li>

                                <li>
                                    <a href="/aggregator/analytics/product">Product </a>
                                </li>
                      ...
                      <!-- =============================================== -->
                        ...
                        <li class="navigation__active">
                            ...
                            <ul>
                               ...
                               <li>
                                    <a href="/aggregator/settlement/uploader"> Uploader</a>
                                </li>
...
let new_data = user().getData({
          url:"/aggregator/getCurrentAdminData",
          method :"GET",
