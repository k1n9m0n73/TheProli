...
<div class="data-table-area mg-b-15">
    ...
    <form token method="post" forms >
                        ...
                        <div class="row data-count" >
                         ...
                         <div class="col-sm-6 col-md-6 col-xs-12 prod_"    >
                         
                         </div>

                         <div class="col-sm-6 col-md-6 col-xs-12 ord_"    >
...
function gData(callback,who){
 ...
 let item_category = user().getData({ 
     ...
     appends:d,
     url:"/aggregator/dataGraph/"+who.slug,
     token:document.querySelector("form[token]").querySelector("input[name='_token']").value
    });
;
/////////////////////////////////
...
},{name:'Product',slug:'prodGraph',abbrName:'prod',chart:"prod_",path:"/aggregator/product/all",ylb:"Number of product"})
...
{name:'Order',slug:'orderGraph',abbrName:'ord',chart:"ord_",path:"/aggregator/analytics/order",ylb:"Number of order"}
)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
checkVal("/aggregator/checkDocument/business")
</script>
</html>