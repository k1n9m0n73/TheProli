                                ...
                                <div class="breadcome-heading">
                                      ...
                                      <div class="smart-search smart-search4">
                                          ...
                                          <div class="select-category" component="admin">
                                            ...
                                            <li cate_id="aiNUI"  seek="Enter order id or transation id"><a href="#" cate_id="aiNUI"  seek="Enter order id or transation id" >Order</a></li>
                                            <li cate_id="aiNUIUyy" seek="Enter product sku, category,subcategory,type..."><a href="#" cate_id="aiNUIUyy" seek="Enter product sku, category,subcategory,type...">Product</a></li>
                                            <li cate_id="aiNUIWiid"  seek="Enter the admin email"><a href="#" cate_id="aiNUIWiid"  seek="Enter the admin email">Admin</a></li>

                                            <li cate_id="iNOM0SuJ" seek="Enter the aggregator email"><a href="#" cate_id="iNOM0SuJ" seek="Enter the aggregator email" >Aggregator</a></li>

                                            <li cate_id="uhGfQKrg"  seek="Enter the customer email"><a href="#" cate_id="uhGfQKrg"  seek="Enter the customer email" >Customer</a></li>

                                            <li cate_id="WErtRT33hf"  seek="Enter the farmer email">
                                                <a href="#" cate_id="WErtRT33hf" seek="Enter the farmer email">Farmer</a></li>
                                            <li cate_id="WErtRT33hfQWed1W" seek="Enter the hub email"><a href="#" cate_id="WErtRT33hfQWed1W" seek="Enter the hub email">Hub</a></li>

                                            <li cate_id="jfjjjjjjj$WWR" seek="Enter the logistics email,business name....."><a href="#" cate_id="jfjjjjjjj$WWR" seek="Enter the logistics email,business name.....">Logistics</a></li>
                                            <li cate_id="WErtRT33hfWa" seek="Enter the warehouse email"><a href="#" cate_id="WErtRT33hfWa" seek="Enter the warehouse email">Warehouse</a></li>
...
<script type="text/javascript">
            ...
            function search(ele,ev){
                     ...
                     let item_subcategory =  user().getData({
                         appends:[JSON.stringify({
                         "Id":ele.value,"find":toFind.value}),0,100], 
                          url:"/search_f",
...
let category_carrirer=``
  data.res.data.forEach( (c,i)=>{
      ...
      category_carrirer += `
                   <div  style="width: 100%; margin-bottom:4px"> 
                    ...
                    <a  s-go href="${c.href_}"><img src="/${c.img_}" alt="" style="width:60px;height:60px;" />
  ...
  document.querySelector(".content-container-wrapper-").innerHTML  = category_carrirer ;
   ...
   let category_carrirer = `<div  style="width: 100%;height: auto;"> 
                        <a  s-go href=""><img src="/usage/demo/img/profile-pics/8.jpg" alt="" style="width:60px;height:60px;" />
                        </a>
                     <div class="search-ajax-title" style="width: 90%;float: right;">
