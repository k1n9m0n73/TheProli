    ...
    padding: .5em;" >0</span>
                                                  <span class="indicator-nt" style="display: none;margin: 7px 7px;"></span>
                                                    ...
                                                    <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                        ...
                                                        <div class="notification-view">
                                                            <a  href="/admin/notification/all">View All Notification</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                       <li><a href="/admin/setting/account-profile#2"><span class="edu-icon edu-home-admin author-log-ic"></span>My Account</a>
                                                        </li>
                                                        <li><a href="/admin/setting/account-profile"><span class="edu-icon edu-user-rounded author-log-ic"></span>My Profile</a>
                                                        </li>
   ...
   function getUNreadMes(){                                                
    promise =  user().getData({
      appends:['wewew',0,2000],
       url:"/admin/message/process/get-unread-message",
...
if (ch.length > 0) {
 ...
 let notsLi = ` <li style="word-spacing:14px;"> 
                      <a href="/admin/message/get#inbox/${unr.a}">
...
<script type="text/javascript" >
 ...
 if (ch.length > 0) {
  ...
  let notsLi = `<li style="width:100%">
                                                                 <a  href="/admin/notification/view#${unr.a_}">
