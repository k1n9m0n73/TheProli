        ...
        <div class="row justify-content-center">
            <div class="col-md-4 col-xs-12">
                <div class="card" style="border: 2px solid #eee; background: #ccc;">
                    <h3 class="card-header text-center bkg ht" style="color:#fff;padding:20px">Admin Request password reset</h3>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.request.password') }}">
                            @csrf
