...
document.querySelector(".box").innerHTML  = p__
   ...
   let tablenew  = ` <table   
                                         ...
                                         <thead>
                                             ...
                                             <tr class="info">
                                                    ...
                                                    <th  data-field="Transaction id"  data-sortable="true"  >Transaction id</th>
                                                    <th  data-field="F(amt)"  data-sortable="true">F(amt)</th>
                                                    <th  data-field="G(amt)" data-sortable="true">G(amt)</th>

                                                    <th  data-field="W(amt)" data-sortable="true">W(amt)</th>
                                                    <th  data-field="L1(amt)" data-sortable="true">L1(amt)</th>
                                                    <th  data-field="L2(amt)" data-sortable="true">L2(amt)</th>

                                                    <th  data-field="L3a(amt)" data-sortable="true">L3a(amt)</th>
                                                    <th  data-field="L3b(amt)" data-sortable="true">L3b(amt)</th>
                                                    <th  data-field="L4a(amt)" data-sortable="true">L4a(amt)</th>

                                                    <th  data-field="L4b(amt)" data-sortable="true">L4b(amt)</th>
                                                    <th  data-field="H1(amt)" data-sortable="true">H1(amt)</th>
                                                    <th  data-field="H2(amt)" data-sortable="true">H2(amt)</th>

                                                    <th  data-field="H3(amt)" data-sortable="true">H2(amt)</th>
                                                    <th  data-field="V(amt)" data-sortable="true">V(amt)</th>
                                                    <th  data-field="I(amt)" data-sortable="true">I(amt)</th>

                                                    <th  data-field="Proli token" data-sortable="true">Proli token</th>
 ...
 /* **Filter selecter****/
  ...
  let new_data = user().getData({
      appends:toAppend,url:"/"+component+"/analytics/process/finance?"+numCof2[1]+"",
 ...
 let  list  =``;
    ...
    dataList.forEach( ($o,$key)=>{
      ...
      list+=`<tr class="parent${$key}"  data-user="${$o.a}" row-index="${($key+1)}"> 
                                        ...
                                        <td  class="upper"> ${$o.a_}</td>
                                        <td  class="upper">${new Intl.NumberFormat('en').format(parseFloat($o.b).toFixed(1) ) }</td>
                                        <td >₦${new Intl.NumberFormat('en').format(parseFloat($o.c).toFixed(1) ) }</td>
                                       
                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.d).toFixed(1) ) }</td>
                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.e).toFixed(1) ) }</td>
                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.f).toFixed(1) ) }</td>

                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.g).toFixed(1) ) }</td>
                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.h).toFixed(1) ) }</td>
                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.i).toFixed(1) ) }</td>

                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.j).toFixed(1) ) }</td>
                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.k).toFixed(1) ) }</td>
                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.k).toFixed(1) ) }</td>

                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.k).toFixed(1) ) }</td>

                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.l).toFixed(1) ) }</td>
                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.m).toFixed(1) ) }</td>
                                        <td>₦${new Intl.NumberFormat('en').format(parseFloat($o.n).toFixed(1) ) }</td>
