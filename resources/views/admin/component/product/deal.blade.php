...
<script type="text/javascript">
 ...
 /* **Filter selecter****/
  ...
  let new_data = user().getData({
      appends:toAppend,url:"/admin/product/process/deal-product?"+numCof2[1]+"",
 ...
 let component = location.pathname.match(/\w+(?=\/)/)[0];
    dataList.forEach( ($o,$key)=>{
      ...
      list+=`<tr class="parent${$key}"  data-user="${$o.a}" row-index="${($key+1)}"> 
                                        ...
                                        <td>${$o.j*100}% off</td>
                                        <td > 
                                     <a   href="/${component}/product/view_detail__${$o.a}"><button type="button" class=" btn btn-xs btn-success "><i class="zwicon-eye" ></i></button></a>
