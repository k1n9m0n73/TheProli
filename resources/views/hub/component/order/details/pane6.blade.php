              ...
              <form enctype="multipart/form-data" class="cate-contaner" id="resp">
                ...
                <div class="col-sm-12 col-md-12 col-xs-12">
                                   ...
                                   <div class="form-group">
                                        <label >Select your hub type </label>
                                       

                                        <select class="select2"  name="type" data-placeholder="Select what to do">  
                                            <option></option>
                                            <option >Hub1</option>
                                  ...
                                  <div class="form-group">
                                        ...
                                        <select class="select2" sta name="status" data-placeholder="Select who to meet">  
                                            <option></option>
                                ...
                                window.addEventListener("load",function (){
                                 ...
                                 s.on("change",function(){
                                  ...
                                  if (  
                                    ...
                                    (this.selectedOptions[0].value.match(/log/i)  )
                                     &&  document.querySelector("select[name='_what']").selectedOptions[0].value==2
                                  
                                  ){

                                      document.querySelector("label[txt]").innerText = "Enter logistics id";
                                      document.querySelector("label[txt]").nextElementSibling.setAttribute("placeholder","Enter logistics id")
                                      document.querySelector("label[txt]").nextElementSibling.setAttribute("name","log_id")
                                  }
...
let btnPassReset = document.querySelector("button.resp");
 ...
 promise =  user().getData({
    ...
    appends:["{{$id}}"], url:"/hub/order/process/logResp",
