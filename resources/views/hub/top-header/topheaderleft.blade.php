    ...
    padding: .5em;" >0</span>
                                                  <span class="indicator-nt" style="display: none;margin: 7px 7px;"></span>
                                                    ...
                                                    <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                        ...
                                                        <div class="notification-view">
                                                            <a  href="/hub/notification/all">View All Notification</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                       <li><a href="/hub/settings/bank"><span class="edu-icon edu-home-admin author-log-ic"></span>My Account</a>
                                                        </li>
                                                        <li><a href="/hub/settings/profile"><span class="edu-icon edu-user-rounded author-log-ic"></span>My Profile</a>
                                                        </li>
                                                        <li><a href="/hub/logout"><span class="edu-icon edu-locked author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
   ...
   function getUNreadMes(){                                                
    promise =  user().getData({
      appends:['wewew',0,2000],
       url:"/hub/message/process/get-unread-message",
...
if (ch.length > 0) {
 ...
 let notsLi = ` <li style="word-spacing:14px;"> 
                      <a href="/hub/message/get#inbox/${unr.a}">
...
<script type="text/javascript" >
 ...
 // window.addEventListener('load',function(){
  ...
  promise = user().getData({
       url:"/hub/notification/process/get-not",
       form:document.querySelector('form[message-unread]'),
       token:document.querySelector('input[name="_token"]').value,
 ...
 if (ch.length > 0) {
  ...
  let notsLi = `<li style="width:100%">
                                                                 <a  href="/hub/notification/view#${unr.a_}">
