            ...
            <div class="collapse- navbar-collapse" id="navbarNav-">
                <ul class="navbar-nav">
                    ...
                    <!-- <li class="nav-item" style="margin: 2em;">
                        <a class="nav-link" href="/hub/login" >Register</a>
                    </li> -->
                    @else
                    <li class="nav-item">
                        <a class="nav-link" href="/hub/logout">Logout</a>
                    </li>
                    @endguest
                </ul>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 col-xs-12">
                <div class="card" style="border: 2px solid #eee; background: #ccc;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('hub.login.custom') }}">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                <div class="checkbox">
                                    <label>
                                      <a href="/hub/forget-password" >Forget password?</a> 
                                    </label>
                                </div>
                            </div>
