                     ...
                     <div class="totalSubcategoryField"><input type="hidden" name="totalSubcategoryField" value="1"></div>
                                  ...
                                  <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 box-white subcategory-container" >
                                    ...
                                    <div class="form-group mt-3">
                                      ...
                                      <input type="text" name="pn1" class="form-control input-mask pn" data-mask="+000-000-000-0000" placeholder="eg: +234-706-437-4020" autocomplete="off" maxlength="17"  is-req="" is-req-text="Main contact number is required" />
                                      </div>
                                      ...
                                      <div class="input-group form-group grouper" style="margin: 0px auto;margin-top: 12px;height:  37.9px;margin-bottom: 10px;width: 100%">
                                    <input type="text" name="pn2" class="form-control input-mask pn" data-mask="+000-000-000-0000" placeholder="eg: +234-706-437-4020 (optional)" autocomplete="off" maxlength="17" is-req-="" is-req-text="Other contact number is required" />
                                      </div>
                                  ...
                                  <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 box-white subcategory-container" >
                                    ...
                                    <div class="form-group mt-3">
                                      ...
                                      <div class="input-group form-group grouper" style="margin: 0px auto;margin-top: 12px;height:  37.9px;margin-bottom: 10px;width: 100%">
                                    <input type="text" name="gpn" class="form-control input-mask pn" data-mask="+000-000-000-0000" placeholder="eg: +234-706-437-4020 " autocomplete="off" maxlength="15" is-req-="" is-req-text="Guarantor contact number is required" />
                                      </div>
                                    </div> 
