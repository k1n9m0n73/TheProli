...
<div class="col-sm-6 col-md-3">
    ...
    <div class="quick-stats__item" style="background-color: #fff;color: #000; box-shadow: 0 0 12px 0;">
        ...
        <div class="quick-stats__chart peity-bar _mon-data-agg-1 agg" style="color: #000">Total order as Hub1</div>
    </div>
...
getCount(dataOrderLog1,{slug:'counter/getCountOrderhub1'})
...
<div class="col-sm-6 col-md-3">
 ...
 <div class="quick-stats__item" style="background-color: #fff;color: #000; box-shadow: 0 0 12px 0;">
     ...
     <div class="quick-stats__chart peity-bar _mon-data-agg-1 agg" style="color: #000">Total order as Hub2</div>
 </div>
...
getCount(dataOrderLog2,{slug:'counter/getCountOrderhub2'})
...
let dataOrderLog3a  = ($d)=>{
 ...
 document.querySelector(".data-count3").innerHTML  = `
<div class="col-sm-6 col-md-3">
 ...
 <div class="quick-stats__item" style="background-color: #fff;color: #000; box-shadow: 0 0 12px 0;">
     ...
     <div class="quick-stats__chart peity-bar _mon-data-agg-1 agg" style="color: #000">Total order as Hub</div>
 </div>
...
getCount(dataOrderLog3a,{slug:'counter/getCountOrderhub3'})
...
{name:'Order',slug:'orderGraph',abbrName:'ord',chart:"ord_",path:"/hub/analytics/order",ylb:"Number of order"}
)
