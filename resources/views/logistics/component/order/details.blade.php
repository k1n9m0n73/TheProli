             ...
             <ul class=" ul_ animated " style="border-radius: 0px;">
               <a href="#0" style="text-decoration: none;"><li class="li_ active_">
                  ...
                  <a href="#7" style="text-decoration: none;">
                     <li class="li_">
                        <span> Enter into catalogue</span>
                    </li>
                  </a>
                   ...
                   //  allbtn.forEach(el=>{
                    ...
                    //  if (e.target.hasAttribute("edit-sch-btn")) {
                        ...
                        let userData = user().getData({
                            appends:['single',0,"{{$id}}"],
                            url:"/logistics/order/process/detail_props_",
                    ...
                    // });
                     ...
                     //})
                         ...
                         <div class="col-md-10 col-lg-10 col-sm-10 -col-xs-12 pane1">
                             @include('logistics.component.order.details.pane0')
                             @include('logistics.component.order.details.pane1')
                             @include('logistics.component.order.details.pane2')
                             @include('logistics.component.order.details.pane3')
                             @include('logistics.component.order.details.pane4')
                             @include('logistics.component.order.details.pane5')
                             @include('logistics.component.order.details.pane6')
                             @include('logistics.component.order.details.pane7')
