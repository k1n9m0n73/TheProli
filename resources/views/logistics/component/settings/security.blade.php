...
resetPassword(document.querySelector("button.reset-password"),document.getElementById("reset-password"),'/logistics/settings/security/resetPass2')
</script>