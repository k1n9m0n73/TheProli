...
<script type="text/javascript">
 ...
 /* **Filter selecter****/
  ...
  let new_data = user().getData({
      appends:toAppend,url:"/admin/users/admin/get/all?"+numCof2[1]+"",
    ...
    dataList.forEach( ($o,$key)=>{
      ...
      list+=`<tr class="parent${$key}"  data-user="${$o.a}" row-index="${($key+1)}"> 
                          <td class="1" col-idex="1"></td>
                                        ...
                                        <td > 
                                     <a   href="/admin/users/admin/view_detail/${$o.a}"><button type="button" class=" btn btn-xs btn-success "><i class="zwicon-eye" ></i></button></a>
