...
<div class="col-sm-12 col-md-12"    id="AnnTable" >
  <div class="panel panel-bd lobidrag">
     ...
     <form action="/logistics/create-employment"  department p__ method="post" forms >
      @csrf
        <!-- ./Plugin content:powerpoint,txt,pdf,png,word,xl -->
              <div class="table-responsive list-r">
                      ...
                      <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 mt-4" style="display: none;">
                                        <div class="input-group">
...
<script type="text/javascript">
   ...
   let tablenew  = ` <table   class="table"  data-toggle="table-" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                         ...
                                         <thead>
                                             ...
                                             <th data-checkbox="true">id</th>
                                                    ...
                                                    <th>Vehicle capacity (tonnes)</th>
                                                    <th>Vehicle avalability</th>
                                                    <th>Loaded mass (tonnes)</th>
                          ...
                          try{
                           if(document.querySelectorAll('.panel-title').length>1){
                            ...
                            e.innerHTML = ' Vehicle data '//+$otherData.total_data   
                            e2.innerHTML = ' Vehicle data '//+$otherData.total_data   
                          }else{
                              let e =  document.querySelectorAll('.panel-title')[0]
                            e.innerHTML = ' Vehicle data '//+$otherData.total_data  
                          }
 ...
 /* **Filter selecter****/
  ...
  let new_data = user().getData({
      appends:toAppend,url:"/logistics/vehicleAction/gets?"+numCof2[1]+"",
 ...
 let  list  =``;
    dataList.forEach( ($o,$key)=>{
      console.log($o)
        let imgs  = JSON.parse($o.c_).document.document[0].doc;
        console.log(imgs)
      ...
      list+=`<tr class="parent${$key}"  data-user="${$o.a}" row-index="${($key+1)}"> 
                                        ...
                                        <td class="2" col-idex="2" >
                                         ...
                                         <td>${$o.g==1?"available":"N$ot available"}</td>

                                      

                                        <td>${$o.a_}</td>
                                        <td>${$o.e==1?"active":"Inactive"}</td>
                                        <td > 
                                         <a   href="/logistics/vehicle/detail__${$o.a}">
                                        <button type="button" class=" btn btn-xs btn-success "><i class="zwicon-eye" ></i></button></a>
                                  
                                      <button type="button" index="${$key}" class="del__ btn btn-xs btn-danger delete-wh-r child-delete${$key}"data-toggle="modal" data-target="#deleteschool">
                                      <i class="fa fa-trash-o delete-wh-r" index="${$key}"></i> 
                                      </button>
