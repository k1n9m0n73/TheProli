...
<head>
    ...
    <link rel="stylesheet" href="{{url('/usage/asset/css/summernote/summernote.css')}}">
...
<div class="main-contents">
  ...
  <div class="content-fluid">
				...
				<div class="cart-content-page"  cart-is-not-empty>
					<h2 class="title-shop-page">Your account /  Message Centre</h2>
                </div>
 ...
 <div class="container" >
               <div class="row">
               <a href="/account/index" class="p-a"> Your Account </a>  >> message Centre
                  <div class="col-sm-12">
                     <div class="mailbox">
                              ...
                              <div class="col-xs-4">
                                 <div class="inbox-avatar">
                                    ...
                                    <div class="inbox-avatar-text hidden-xs hidden-sm">
                                       <div class="avatar-name">Customer message box</div>
                                       <div><small></small></div>
                                    </div>
                                 </div>
                              </div>
                        ...
                        <form enctype="multipart/form-data" class="permission" x__ method="post"  action="/account/mail/process/sendMessage">
                            @csrf
...
function makeAction(callBack,form="form[x__]",
 action="/account/mail/process/delete-message",
...
//setTimeout(()=>{getHashReader();},2000)
    ...
    function popData(form,which_ ,id,callback){
      ...
      let userData = user().getData({
          appends:['single',id],
          url:"/account/mail/process/"+which_,
          token:document.querySelector(form).querySelector("input[name='_token']").value,
 ...
 <table class="table table-new-warehouse">
                                  ...
                                  <button type="button" which_="all" class="btn-hide btn btn-xs btn-danger  hide-btn delete-wh-r" del__all  style="margin: 10px">
                                   <i class="fa fa-trash  delete-wh-r" del__all></i></button></th>
                                          ...
                                          <td class="last_"> 
                                           ...
                                           <button
                                            style="cursor:pointer" 
                                              ...
                                              <i class="fa fa-trash delete-wh-r"  index="key" ></i>
                                              </button>
 ...
 if (fileImg.length >0) {
  ...
  img +=`  <div class="col-sm-2 col-xs-4">
       ...
       return(`<div class='message-wrapper' style="color:#000"> <p><strong>From: ${$data_.g_}</strong> <div style="float:right">
                                       <button which_="${$data_.a}" style="cursor:pointer" type="button" index="0" class="del__delt btn btn-xs btn-danger"><i class="fa fa-trash del__delt" ></i></button>
                                     </div></p>
                                    <p>
        ...
        function composeLinkClickEffect(){
             ...
             document.querySelector('[href="#compose"]').addEventListener('click',function($ele){
                ...
                handleSubmitWithSummer("button.__SEND__MESSAGE__","form[x__]",['farmers'],respondsToMessageSend,
                    "/aggregator/uploadImgUrl/usage_images_desc-message"/*uploade class_url/img_dir*/ ,"/usage/images/desc-message/",
