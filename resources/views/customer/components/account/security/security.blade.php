...
<div class="main-contents">
  ...
  <div class="content-fluid">
				...
				<div class="cart-content-page"  cart-is-not-empty>
					<h2 class="title-shop-page">Your account /  Security</h2>
                </div>
                  ...
                  <a href="/account/index" class="p-a"> Your Account </a>  >> Security
          ...
          <h4>My Account Details</h4>
                             ...
                             @csrf
                               ...
                               <div class=" col-md-6 col-sm-6 col-xs-12 contrictor ">
                                            ...
                                            <div class="form-group" >
                                              <label>Password (if someome is watching, becareful)</label>
                                                <input type="text"  name="password" value=""  placeholder="password" autocomplete="off" is-req="" is-req-text="Business name is required"  value="" >
                                           </div>
                                           ...
                                           <label>Date update token</label>
                                            ...
                                            <div class="form-group" >
                                                 ...
                                                 <button type="button" name="save_pass"  is_category_request class="btn btn-theme" >Save <i class="fa fa-spinner anim" style="opacity: 0;"></i></button>
                                            </div>
