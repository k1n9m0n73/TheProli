...
!(function (a) {
    ...
    var j = "ontouchstart" in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
        ...
        o = (function () {
            var b = function (b) {
                  ...
                  //  console.log(b.parentElement.parentElement.children[1] )   
         //                        let lineHeight_ = `
         //    <div class="note-btn-group btn-group note-lineheight">
         //    <div class="note-btn-group btn-group">
         //    <button type="button" class="note-btn btn btn-default btn-sm dropdown-toggle" tabindex="-1" data-toggle="dropdown" title="" data-original-title="Font Family" aria-expanded="true">
         //    <span class="note-current-lineheight">Line Spacing</span> 
         //    <span class="note-icon-caret"></span>
         //    </button>
         //    <div class="dropdown-menu note-check dropdown-fontname">
         //    <li><a href="#" data-value="1.0">1.0</a></li>
         //    <li><a href="#" data-value="2.0">2.0</a></li>
         //    <li><a href="#" data-value="3.0">3.0</a></li>
         //    <li><a href="#" data-value="4.0">4.0</a></li>
         //    <li><a href="#" data-value="5.0">5.0</a></li>
         //    <li><a href="#" data-value="6.0">6.0</a></li>
         //    <li><a href="#" data-value="7.0">7.0</a></li>
         //    <li><a href="#" data-value="8.0">8.0</a></li>
         //    <li><a href="#" data-value="9.0">9.0</a></li>
         //    <li><a href="#" data-value="10.0">10.0</a></li>
         //    <li><a href="#" data-value="11.0">11.0</a></li>
         //    <li><a href="#" data-value="12.0">12.0</a></li>
         //    <li><a href="#" data-value="13.0">13.0</a></li>
         //    <li><a href="#" data-value="14.0">14.0</a></li>
         //    <li><a href="#" data-value="15.0">15.0</a></li>
         //    <li><a href="#" data-value="16.0">16.0</a></li>
         //    <li><a href="#" data-value="17.0">17.0</a></li>
         //    <li><a href="#" data-value="18.0">18.0</a></li>
         //    <li><a href="#" data-value="19.0">19.0</a></li>
         //    <li><a href="#" data-value="19.0">19.0</a></li>
         //    <li><a href="#" data-value="20.0">20.0</a></li>
         //    <li><a href="#" data-value="21.0">21.0</a></li>
         //    <li><a href="#" data-value="22.0">22.0</a></li>
         //    <li><a href="#" data-value="23.0">23.0</a></li>
         //    <li><a href="#" data-value="24.0">24.0</a></li>



         //     </div></div></div>`
         //     try{
         //     Array.from(b.parentElement.parentElement.children[1].children).forEach(c=>{
         //         if (c.className.match("note-lineheight")) {c.remove()}
         //     })

     
         //   ///  if (b.parentElement.parentElement.children[1].children.className.match("note-lineheight")) {}
         //            b.parentElement.parentElement.children[1].insertAdjacentHTML("afterbegin",lineHeight_)  

         // //     window.addEventListener('load',function(){
         //              document.querySelectorAll(".note-lineheight > div>div>li >a").forEach(e=>{
         //            e.addEventListener("click",function(){

         //                console.log(this.dataset.value)
         //                this.parentElement.parentElement.parentElement.children[0].children[0].innerText = this.dataset.value
         //            })
         //        }) 
         //          //})
         //  }catch(e){
            ...
            var c = this,
                ...
                i = (this.representShortcut = function (a) {
                    ...
                    return f.shortcuts && b
                        ? (k.isMac && (b = b.replace("CMD", "Ã¢Å’Ëœ").replace("SHIFT", "Ã¢â€¡Â§")), " (" + (b = b.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")) + ")")
                        : "";
                });
            (this.initialize = function () {
    ...
    a.summernote = a.extend(a.summernote, {
        ...
        options: {
            ...
            toolbar: [
                ["style", ["style"]],
                ["font", ["bold", "underline", "clear","subscript","superscript","italic","strikethrough"]],
                ["fontname", ["fontname"]],
                ["fontsize", ["fontsize"]],
                ["color", ["color"]],
            ...
            insertTableMaxSize: { col: 100, row: 100 },
            dialogsInBody: !1,
            dialogsFade: !1,
