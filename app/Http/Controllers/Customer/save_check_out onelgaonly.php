...
//////////////if there is not logistics that will do home delivery from state leve///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   if(count($log) >0) {//////////////////////////////else select the logistic that can do the delivery at state level
      $pat  = (array)$log[0]; 
  //  print_r($pat);
      $pat = [
        'vehid'=>$pat['data_id'],
  ...
  return ['deliverable'=>0,'reason'=>'logistic nor=t found','log'=>[]];
      ...
      return ['deliverable'=>0,'reason'=>!empty($storage)?"Customer not found":"Storage not found" ,'log'=>[]];
    }
