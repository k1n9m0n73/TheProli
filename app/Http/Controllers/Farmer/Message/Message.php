<?php
namespace App\Http\Controllers\Farmer\Message;
use App\Http\Controllers\Farmer\Message\Trait\MessageTrait;
...
{     use MessageTrait;
    ...
    {  
       ...
       if (Auth::check()) {
           ...
           //////////////////////////////////////////////
              if($id == 'get'){
                  return view('farmer.component.message.message',['user'=>Auth::user()]);  
              }
              /////////////////////////////////
