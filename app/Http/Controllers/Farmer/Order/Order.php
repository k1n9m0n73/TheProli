...
{
      use  \App\Http\Controllers\Farmer\Order\Trait\OrderTraitGet ;
       ...
       if (Auth::check()) {
           ...
           //////////////////////////////////////////////
              if($id == 'today'){
                         ...
                         return view('farmer.component.order.today',['user'=>Auth::user()]);  
              ...
              if($id == 'other_date_order'){
                    return view('farmer.component.order.order_date',['user'=>Auth::user()]);     
         }
         /////////////////////////////////

         
         if($id == 'return_order'){
              return view('farmer.component.order.return',['user'=>Auth::user()]);      
   }
   /////////////////////////////////
                ...
                if(preg_match('/details__/',$id)){
                   ...
                   return view('farmer.component.order.details',['user'=>Auth::user(),'id'=>$item_id_container[1]]); 
