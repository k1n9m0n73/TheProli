...
class ForgetPasswordController extends Controller
{
   public function __construct()
   {
      ...
      $this->middleware("guest:far")->except($this->component."/forget-password"); //the name of the guard in config/auth
    ...
    public function requestPassword(Request $request)
    {
        ...
        $rem   = true;
        if (!empty($user)) {
          $mess  = "".$user->fn." ".$user->ln." has requested for password reset on THE PROLI ".$this->component."  dashboard. Click the link below to reset it ";  
