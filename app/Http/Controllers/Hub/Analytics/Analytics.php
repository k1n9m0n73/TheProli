<?php
namespace App\Http\Controllers\Hub\Analytics;

use App\Http\Controllers\Hub\Analytics\Trait\Order;
       ...
       if (Auth::check()) {
              ...
              /////////////////////////////////
                   ...
                   if($id == 'order'){
                      ...
                      return view('hub.component.analytics.order',['user'=>Auth::user()]);  
