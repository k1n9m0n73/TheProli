...
class ResetPasswordController extends Controller
{
   public function __construct()
   {
    ...
    $this->token  = '';
    $this->component   = 'hub';
      $this->middleware("guest:hub")->except($this->component."/login"); //the name of the guard in config/auth
    ...
    public function resetPassword(Request $request)
    {
        ...
        if($_POST['password']  !=$_POST['confirm_password']   ){
            return redirect("hub/password-reset/{$request->email}/{$request->token}")->withErrors('Password and repeat password are not equall');
