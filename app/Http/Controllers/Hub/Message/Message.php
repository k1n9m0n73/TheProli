<?php
namespace App\Http\Controllers\Hub\Message;
use App\Http\Controllers\Hub\Message\Trait\MessageTrait;
...
{     use MessageTrait;
    ...
    {  
       ...
       if (Auth::check()) {
           ...
           //////////////////////////////////////////////
              if($id == 'get'){
                  return view('hub.component.message.message',['user'=>Auth::user()]);  
              }
              /////////////////////////////////
