...
class Document extends Controller
{
    ...
    {  
        ...
        return view('logistics.component.settings.document',['user'=>Auth::user(), 
        'data'=>  !empty((array)$doc) ?['doc'=> $doc->logistics]:json_encode([]) ]);  
  ...
  $doc = ['document'=>$company_document];
       ...
       try {
          $s  =   ['content'=>'I '.$this->user->bn.' .Logistics partner with email '.$this->user->email.' has upload one of my document. </br> Please perform immidiate activation on my vehicles if they have been deactivated'];
