<?php
namespace App\Http\Controllers\Logistics\Message;
use App\Http\Controllers\Logistics\Message\Trait\MessageTrait;
...
{     use MessageTrait;
    ...
    {  
       ...
       if (Auth::check()) {
           ...
           //////////////////////////////////////////////
              if($id == 'get'){
                  return view('logistics.component.message.message',['user'=>Auth::user()]);  
              }
              /////////////////////////////////
