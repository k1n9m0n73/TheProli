...
class War extends Controller
{
    ...
    {  
          ...
          $this->user_part  = "war";
          $this->user_part_table  = "warehouses";
         ...
         $this->middleware(function ($request, $next ) {
          ...
          $this->user_perm = [
            ...
            property_exists($permission,'ppar__allow_to_view_warehouse') && $permission->ppar__allow_to_view_warehouse==1?1:0,
         ...
         $this->user_gperm  =   [
          ...
          property_exists($gpermission,'ppar__allow_to_view_warehouse') && $gpermission->ppar__allow_to_view_warehouse==1?1:0,
          property_exists($gpermission,'ppar__allow_to_edit_warehouse') && $gpermission->ppar__allow_to_edit_warehouse==1?1:0,
          property_exists($gpermission,'ppar__allow_to_delete_warehouse') && $gpermission->ppar__allow_to_delete_warehouse==1?1:0,
          property_exists($gpermission,'papp__allow_to_approve_warehouse') && $gpermission->papp__allow_to_approve_warehouse==1?1:0,
