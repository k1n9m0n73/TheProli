<?php
namespace App\Http\Controllers\Warehouse\Analytics\Trait;
use Module\Escape;
...
{ 
        ...
        private function productAnalytic($request){
           ...
           //print_r($de);
            ...
            $item = $item->where('item_storage',$this->user->user_id)->take(Escape::done($_POST['post2']))->skip(Escape::done($_POST['post1']))->get();
