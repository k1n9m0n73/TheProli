<?php
namespace App\Http\Controllers\Warehouse\Message;
use App\Http\Controllers\Warehouse\Message\Trait\MessageTrait;
...
{     use MessageTrait;
    ...
    {  
       ...
       if (Auth::check()) {
           ...
           //////////////////////////////////////////////
              if($id == 'get'){
                  return view('warehouse.component.message.message',['user'=>Auth::user()]);  
              }
              /////////////////////////////////
