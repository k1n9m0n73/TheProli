<?php
namespace App\Http\Controllers\Warehouse\Settlement\Trait;
use Module\Escape;
...
private function productStoreSettlement($request){
    ...
    if (isset($_POST['post0'])) {
        ...
        ->where("partner_settlement.warehouser_id", "!=", "NULL")->where("partner_settlement.warehouser_id", $this->user->user_id);
