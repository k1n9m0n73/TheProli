...
class Document extends Controller
{
    ...
    {  
        ...
        return view('warehouse.component.settings.document',['user'=>Auth::user(), 
        'data'=>  !empty((array)$doc) ?['doc'=> $doc->warehouse]:json_encode([]) ]);  
  ...
  $doc = ['document'=>$company_document];
       ...
       try {
          $s  =   ['content'=>'I '.$this->user->bn.' .wahouse partner with email '.$this->user->email.' has upload one document. confirm the coducment validity'];
