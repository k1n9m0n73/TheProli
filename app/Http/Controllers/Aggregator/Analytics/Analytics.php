<?php
namespace App\Http\Controllers\Aggregator\Analytics;

use App\Http\Controllers\Aggregator\Analytics\Trait\Order;
use App\Http\Controllers\Aggregator\Analytics\Trait\Product;
...
{     use Product,Order;
    ...
    {  
       ...
       if (Auth::check()) {
           ...
           //////////////////////////////////////////////
              if($id == 'product'){
                  return view('aggregator.component.analytics.product',['user'=>Auth::user()]);  
              ...
              /////////////////////////////////
                   ...
                   if($id == 'order'){
                      ...
                      return view('aggregator.component.analytics.order',['user'=>Auth::user()]);  
